...
cdo yearmax $dis1 tmp_max1.nc
cdo yearmin $dis1 tmp_min1.nc
cdo yearmax $dis2 tmp_max2.nc
cdo yearmin $dis2 tmp_min2.nc
...
cdo yearavg $dis1 tmp_ya1.nc
cdo yearavg $dis2 tmp_ya2.nc
...
# IAH 1b: Seasonal Mean Volume
cdo yseasavg $dis1 tmp_sa1.nc
cdo yseasavg $dis2 tmp_sa2.nc

# IAH 1b Ratio
cdo -L -div tmp_sa2.nc tmp_sa1.nc tmp_IAH1b.nc
...
cdo -L -yearpctl,10 $dis1 tmp_min1.nc tmp_max1.nc tmp_1d10.nc
cdo -L -yearpctl,90 $dis1 tmp_min1.nc tmp_max1.nc tmp_1d90.nc
cdo sub tmp_1d90.nc tmp_1d10.nc tmp_ddiff1.nc
cdo timavg tmp_ddiff1.nc tmp_ddiffavg1.nc

cdo -L -yearpctl,10 $dis2 tmp_min2.nc tmp_max2.nc tmp_2d10.nc
cdo -L -yearpctl,90 $dis2 tmp_min2.nc tmp_max2.nc tmp_2d90.nc
...
cdo -L -yearpctl,95 $dis1 tmp_min1.nc tmp_max1.nc tmp_1y95.nc
cdo timavg tmp_1y95.nc tmp_1ya95.nc
cdo -L -yearpctl,95 $dis2 tmp_min2.nc tmp_max2.nc tmp_2y95.nc
...
cdo -L -gt -selyear,$tmp_envs discharge_dailyTot_Environmental -timavg -selyear,$envs tmp_1y95.nc tmp_env95$tmp_envs.nc
...
cdo -L -gt -selyear,$tmp_alts discharge_dailyTot_BAU -timavg -selyear,$alts tmp_1y95.nc tmp_alt95$tmp_alts.nc
let "tmp_alts = $tmp_alts + 1"
done
cdo mergetime tmp_alt95* tmp_alt_final.nc

# IAH 12 Ratio
cdo -L -sub tmp_1.nc -mulc,0.2 -abs -sub tmp_alt_final.nc tmp_env_final.nc tmp_IAH12.nc
cdo timavg tmp_IAH12.nc IAH12.nc
...
cdo -L -yearpctl,5 $dis1 tmp_min1.nc tmp_max1.nc tmp_1y05.nc
cdo timavg tmp_1y05.nc tmp_1ya05.nc
cdo -L -yearpctl,5 $dis2 tmp_min2.nc tmp_max2.nc tmp_2y05.nc
...
# IAH 18: Days per month no flow - Q = 0 
cdo -L -eqc,0 discharge_dailyTot_Environmental tmp_1days0.nc
cdo -L -ymonavg tmp_1days0.nc tmp_1avgdays0.nc
cdo -L -eqc,0 discharge_dailyTot_BAU tmp_2days0.nc
cdo -L -ymonavg tmp_2days0.nc tmp_2avgdays0.nc

# IAH 18 Ratio
cdo -L -sub tmp_1.nc -mulc,0.2 -abs -sub tmp_2avgdays0.nc tmp_1avgdays0.nc tmp_IAH18.nc
cdo timavg tmp_IAH18.nc IAH18.nc
...
echo ""
echo "Calculating year: $tmp_envs"
cdo -L -gt -selyear,$tmp_envs discharge_dailyTot_Environmental -timavg -selyear,$envs tmp_1y05.nc tmp_env05$tmp_envs.nc
let "tmp_envs = $tmp_envs + 1"
done
...
echo ""
echo "Calculating year: $tmp_alts"
cdo -L -gt -selyear,$tmp_alts discharge_dailyTot_BAU -timavg -selyear,$alts tmp_1y05.nc tmp_alt05$tmp_alts.nc
let "tmp_alts = $tmp_alts + 1"
done
cdo mergetime tmp_alt05* tmp_alt_final.nc

# IAH 19 Ratio
cdo -L -sub tmp_1.nc -mulc,0.2 -abs -sub tmp_alt_final.nc tmp_env_final.nc tmp_IAH19.nc
cdo timavg tmp_IAH19.nc IAH19.nc
...
# Average all IAHs
rm IAH_average.nc
cdo -L -ifthen river_mask.nc -ensavg IAH* IAH_average.nc
